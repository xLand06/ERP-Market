...
// ÔöÇÔöÇÔöÇ Types ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
interface Product { id: string; name: string; price: number; stock: number; category: string; code: string; emoji: string; }
interface CartItem extends Product { qty: number; }

// ÔöÇÔöÇÔöÇ Constants ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
const VES_RATE = 36.50;
const IVA = 0.16;
const CATEGORIES = ['Todos','Abarrotes','L├ícteos','Bebidas','Limpieza','Carnes'];
const PRODUCTS: Product[] = [
    { id:'1', code:'HPAN001', name:'Harina PAN 1kg',       price:1.20, stock:3,  category:'Abarrotes', emoji:'­ƒî¢' },
    { id:'2', code:'ACEL002', name:'Aceite Mazola 1L',     price:2.50, stock:15, category:'Abarrotes', emoji:'­ƒ½Ö' },
    { id:'3', code:'LCHE003', name:'Leche Completa 1L',    price:1.40, stock:8,  category:'L├ícteos',   emoji:'­ƒÑø' },
    { id:'4', code:'ARRO004', name:'Arroz Cristal 1kg',    price:0.95, stock:45, category:'Abarrotes', emoji:'­ƒìÜ' },
    { id:'5', code:'CAFE005', name:'Caf├® Fama 500g',       price:2.90, stock:2,  category:'Bebidas',   emoji:'Ôÿò' },
    { id:'6', code:'MAYO006', name:'Mayonesa Mavesa 445g', price:1.75, stock:22, category:'Abarrotes', emoji:'­ƒ½Ö' },
    { id:'7', code:'DTRG007', name:'Detergente Ariel 1kg', price:3.40, stock:7,  category:'Limpieza',  emoji:'­ƒº┤' },
    { id:'8', code:'AZUC008', name:'Az├║car Montalb├ín 1kg', price:1.00, stock:38, category:'Abarrotes', emoji:'­ƒºé' },
    { id:'9', code:'SARD009', name:'Sardinas Corona',      price:1.80, stock:24, category:'Abarrotes', emoji:'­ƒÉƒ' },
    { id:'10',code:'MANT010', name:'Mantequilla Planta',   price:2.20, stock:11, category:'L├ícteos',   emoji:'­ƒºê' },
    { id:'11',code:'PPAN011', name:'Papel Sanitario 12R',  price:4.50, stock:20, category:'Limpieza',  emoji:'­ƒº╗' },
    { id:'12',code:'QESO012', name:'Queso Blanco 500g',    price:3.80, stock:6,  category:'L├ícteos',   emoji:'­ƒºÇ' },
];

const PAYMENT_OPTIONS = [
    { id:'cash_usd',  label:'Efectivo USD',    icon:DollarSign, currency:'USD' as const },
    { id:'pagomovil', label:'Pago M├│vil VES',  icon:Smartphone, currency:'VES' as const },
    { id:'tarjeta',   label:'Tarjeta',         icon:CreditCard, currency:'USD' as const },
];

// ÔöÇÔöÇÔöÇ Stock Badge ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇÔöÇ Product Card ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇÔöÇ Hybrid Payment Dialog ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    return (
        <Dialog open={open} onOpenChange={o => !o && onClose()}>
            <DialogContent className="max-w-md">
                <DialogHeader>
                    <DialogTitle>M├®todo de Pago H├¡brido</DialogTitle>
                    <DialogDescription>Combina m├║ltiples m├®todos de pago</DialogDescription>
                </DialogHeader>
...
// ÔöÇÔöÇÔöÇ Toast ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// ÔöÇÔöÇÔöÇ Main Page ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
export default function POSPage() {
    ...
    const handleConfirm = () => {
        ...
        toast('Ô£ô Venta completada ┬À Ticket #0342 generado');
    };
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-4 h-full lg:h-[calc(100dvh-64px-48px)] overflow-y-auto lg:overflow-hidden pb-6 lg:pb-0 scroll-smooth">
            {/* ÔöÇÔöÇ LEFT: Product search ÔöÇÔöÇ */}
            <div className="flex-[6] flex flex-col gap-4 bg-white rounded-xl border border-slate-200 p-4 sm:p-5 shadow-sm overflow-hidden min-h-[500px] lg:min-h-0">
                ...
                <div className="relative">
                    ...
                    <Input
                        ref={searchRef}
                        placeholder="Buscar por nombre, c├│digo o escanear... [F2]"
                        value={search}
                ...
                <p className="text-[11px] text-slate-400 lg:flex hidden items-center gap-1.5">
                    <Keyboard className="w-3.5 h-3.5" /> [F2] Buscar ┬À [Ctrl+Enter] Cobrar ┬À [Esc] Cerrar
                </p>
            </div>

            {/* ÔöÇÔöÇ RIGHT: Ticket ÔöÇÔöÇ */}
            <div className="flex-[4] flex flex-col bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden min-h-[600px] lg:min-h-0">
                ...
                <div className="flex items-center justify-between px-5 py-5 border-b border-slate-100">
                    <div>
                        ...
                        <p className="text-[11px] text-slate-400">Cajera: Mar├¡a Gonz├ílez</p>
                    </div>
                    {cart.length > 0 && (
                    ...
                    {cart.length === 0 ? (
                        <div className="h-full flex flex-col items-center justify-center gap-3 text-slate-400 py-12">
                            <div className="bg-slate-50 w-16 h-16 rounded-full flex items-center justify-center">
                                <span className="text-4xl opacity-30">­ƒøÆ</span>
                            </div>
                            <div className="text-center">
                                <p className="text-sm font-semibold">Carrito vac├¡o</p>
