    ...
    return (
        <div className="flex flex-col lg:flex-row gap-4 h-full lg:h-[calc(100dvh-112px)] overflow-hidden pb-16 lg:pb-0 relative">
            ...
            {mobileTab === 'catalog' && totals.itemCount > 0 && (
                <div className="fixed bottom-20 left-3 right-3 z-[35] sm:bottom-3 lg:hidden bg-slate-900 text-white p-3 rounded-2xl shadow-2xl border border-slate-800 flex items-center justify-between animate-slide-up">
