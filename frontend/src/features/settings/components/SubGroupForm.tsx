                ...
                <form onSubmit={handleSubmit} className="p-2 space-y-4">
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-3.5 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm focus:outline-none focus:border-indigo-500 text-slate-900 dark:text-slate-100 transition-all font-bold"
                            required
                        >
