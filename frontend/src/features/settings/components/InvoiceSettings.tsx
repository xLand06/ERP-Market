    ...
    return (
        <form onSubmit={handleSaveAll} className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 space-y-6">
                ...
                {/* SECCIÓN 0: TEMAS DE INTERFAZ DE LA APLICACIÓN (5 PRESETS) */}
                <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-2xs space-y-4">
                    <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 font-medium">Elige entre 5 temas de color preestablecidos para toda la aplicación.</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                        {[
                            ...
                            },
                            {
                                ...
                                accentBg: 'bg-indigo-50 border-indigo-300',
                            ...
                            },
                            {
                                ...
                                accentBg: 'bg-amber-50 border-amber-300',
                            ...
                            },
                            {
                                ...
                                accentBg: 'bg-rose-50 border-rose-300',
                            ...
                            },
                            {
                                ...
                                accentBg: 'bg-slate-900 border-slate-700 text-emerald-400',
                                textColor: 'text-emerald-400',
                            },
                        ].map((t) => {
                            const isSel = (config.activeTheme || 'emerald') === t.id;
                            return (
                                <button
                                    key={t.id}
                                    type="button"
                                    onClick={() => {
                                        config.setTheme(t.id as any);
                                        toast.success(`Tema "${t.name}" activado`);
                                    }}
                                    className={cn(
                                        'p-3.5 rounded-2xl border-2 text-left transition-all active:scale-95 flex flex-col justify-between gap-2.5 cursor-pointer',
                                        isSel
                                            ? 'bg-slate-50 border-indigo-600 shadow-md ring-2 ring-indigo-600/30'
