            ...
            <div className="flex items-center gap-1 lg:gap-3 shrink-0">
                ...
                <div className="hidden sm:flex items-center gap-1 bg-slate-100/80 p-1 rounded-xl border border-slate-200/50">
                    ...
                    <button 
                        ...
                        className="w-10 h-10 lg:w-9 lg:h-9 flex items-center justify-center text-slate-500 hover:bg-white hover:text-emerald-600 rounded-lg transition-all active:scale-95 min-w-10" 
